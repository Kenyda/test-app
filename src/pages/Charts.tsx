...
const Charts = () => {
  const ACTIVITY_SCHEDULE_CARD_TEXT =
    "Если ваша кошка лежит с закрытыми глазами и кажется, что она спит,\n" +
      ...
      <Card sx={{ mt: 3 }}>
        ...
        <CardContent>
          ...
          <Typography className="description">
            Статистика примерная, и по большей части высчитывалась по продажам
            кормов для питомцев.
          </Typography>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <Grid container justifyContent="space-around">
            <Grid item md={8}>
              <BreedsSchedule />
              <Typography className="description">
                При составлении рейтинга использовалась статистика запросов
                различных пород кошек в интернете.
              </Typography>
            </Grid>
          </Grid>
        </CardContent>
