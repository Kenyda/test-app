...
const SchedulesInfo = () => {
  return (
    <Card sx={{ mt: 3 }}>
      ...
      <CardContent>
        <Typography>
          Мода на породы кошек изменчива. Но меняется она не так часто, как
          мода, скажем, на одежду или дизайн интерьеров. В кошачьем мире, если
          уж порода стала востребованной, она продержится на Олимпе куда больше
          года, как например:
        </Typography>
        <List dense={true}>
